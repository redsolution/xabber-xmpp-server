...
%%%
%%% @end
%%% Created : 20. нояб. 2020 11:50
%%%-------------------------------------------------------------------
-module(xabber_channels_sm).
...
handle_info({route, #presence{} = Packet}, State = #xabber_sm_state{}) ->
  mod_channel_presence:process_presence(Packet),
  {noreply, State};
handle_info({route, #iq{} = Packet}, State = #xabber_sm_state{}) ->
  mod_channels_iq_handler:process_iq(Packet),
  {noreply, State};
handle_info({route, #message{} = Packet}, State = #xabber_sm_state{}) ->
  mod_channel_message:do_route(Packet),
  {noreply, State};
