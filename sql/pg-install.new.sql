...
CREATE INDEX i_archive_sh_user_bpeer_ctype_ts ON archive USING btree (server_host, username, bare_peer, conversation_type, timestamp);
...
CREATE TABLE conversation_metadata(
    ...
    read_until_ts bigint NOT NULL DEFAULT 0,
    delivered_until text NOT NULL DEFAULT '0',
    delivered_until_ts bigint NOT NULL DEFAULT 0,
    displayed_until text NOT NULL DEFAULT '0',
    displayed_until_ts bigint NOT NULL DEFAULT 0,
